...
const PROVEN_TARGETS: ProvenTarget[] = [
  {
    ...
    sector: "E-commerce · full evidence",
    url: "https://www.scrapingcourse.com/ecommerce/product/abominable-hoodie/",
    a: "CA", b: "TX",
    note: "Live $69 capture + BOTH screenshots + sealed evidence + PDF — the complete flow",
    tier: "Headline",
  },
  {
    rank: 2,
    label: "Books to Scrape — single product",
    sector: "Retail · full evidence",
    url: "https://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html",
    a: "CA", b: "TX",
    note: "Live £51.77 capture + screenshots · rock-solid reliability anchor",
    tier: "Strong",
  },
  {
    rank: 3,
    label: "Properstar — international property",
    sector: "Real estate · UK↔EU (HTML only)",
    url: "https://www.properstar.com/",
    a: "GB", b: "DE",
    note: "Live HTML scrape · real €100k+ listings · proves UK↔EU coverage (heavy site: no screenshot)",
    tier: "Reliable",
  },
  {
    rank: 4,
    label: "GlobalListings — property portal",
    sector: "Real estate · US↔EU (HTML only)",
    url: "https://www.globallistings.com/",
    a: "US", b: "DE",
    note: "Live HTML scrape · real $275k–$2.4M listings · US↔EU coverage",
    tier: "Reliable",
  },
];
