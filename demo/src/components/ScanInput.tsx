...
const PROVEN_TARGETS: ProvenTarget[] = [
  {
    ...
    a: "GB", b: "DE",
    note: "Real €100k+ property listings · live scrape · proves UK↔EU coverage",
    tier: "Headline",
  },
  {
    rank: 2,
    ...
    a: "US", b: "DE",
    note: "Real $275k–$2.4M property listings · live scrape · US↔EU coverage",
    tier: "Strong",
  },
  {
    rank: 3,
    label: "Hotels.com — hotel + dates",
    sector: "Lodging · FTC §464",
    url: "https://www.hotels.com/ho138935/?chkin=2026-08-15&chkout=2026-08-17&rooms=1&adults=2",
    a: "GB", b: "US",
    note: "Real hotel · Browser API full render + screenshot · vision reads JS prices (may need a retry)",
    tier: "Strong",
  },
];
