...
# Force offline: blank ALL Bright Data creds so the smoke test never makes live
# calls (env vars override .env in pydantic-settings). Every BRIGHTDATA_* key
# must be listed, or the smoke will silently make slow live fetches.
